...
/**
 * 1차 입력 탭.
 * 선택 날짜 기준 빠른 입력만 담당하고, 선택 날짜 자체는 캘린더/그래프와 공유한다.
 */
@Composable
internal fun EntryScreen(vm: BpViewModel) {
    ...
    LazyColumn(
        ...
        item {
            QuickEntryCard(
                ...
                onDeleteMorning = vm::deleteMorning,
                onDeleteEvening = vm::deleteEvening,
                onDeleteWeight = vm::deleteWeight
            )
        }
    }
}
